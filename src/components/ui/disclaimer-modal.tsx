      ...
      <div className="relative bg-white rounded-lg p-6 max-w-2xl w-full mx-4 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2 text-sm text-gray-600">
            ...
            <p>• The different stablecoins accepted by Merchants through this program are not audited by us, we have no control over them, and their integration into this program does not mean we support, agree with, or condone their designs, capabilities, or issuing entities in any way. We are not responsible if any or all of them fail or lose their value or dollar peg.</p>
            <p>• Some of the stablecoins integrated into this program have a <em>Freeze Authority</em> or <em>Permanent Delegate</em>, and can be frozen or taken from your account without your permission by the issuing entity. We have NO control over this. You are responsible for understanding which coins have these parameters, and which ones you decide to hold or use.</p>
            <p>• We have integrated the following 8 stablecoins as payment options: USD Circle (USDC), Tether (USDT), PayPal USD (PYUSD), Ondo US Dollar Yield (USDY), Agora USD (AUSD), MoveMoney USD (MoveUSD), First Digital USD (FDUSD), and Global Dollar (USDG).</p>

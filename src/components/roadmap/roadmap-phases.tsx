...
const phases: Phase[] = [
  {
    number: 1,
    title: 'Solana Breakout Hackathon (v0.0.1)',
    items: [
      ...
      { text: 'Integrate gas fee-payer accounts for Merchants and their customers on devnet', completed: true },
  ...
  {
    number: 2,
    title: 'Prepare Program for Mainnet Launch with MVP version (v0.1.0)',
    items: [
      { text: 'Trim the Anchor program to acceptable MVP levels (Merchant Point of Sale)', completed: false },
      { text: 'Security audit Anchor backend', completed: false },
      ...
      { text: 'Integrate Jupiter Terminal for USDC to Perena USD* swap on main net; with referral code (our first in-app DeFi yield opportunity, front-end integration only)', completed: true },
  ...
  {
    number: 3,
    title: 'Onboard Merchants, Begin Building Next Version (v1.0.0)',
    items: [
  ...
  {
    number: 4,
    title: 'Focus on Customer On-boarding (end Customers, not Merchants)',
    items: [
  ...
  {
    number: 5,
    title: 'Integrate Merchant and Customer Feedback, start building stretch goals (v2.0.0)',
    items: [

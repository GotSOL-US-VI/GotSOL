...
const phases: Phase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'Integrate Jupiter Terminal for USDC to Perena USD* swap on main net; with referral code (our first in-app DeFi yield opportunity, front-end integration only)', completed: false },
